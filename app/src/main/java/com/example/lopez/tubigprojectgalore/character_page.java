...
public class character_page extends AppCompatActivity {
    ...
    private Button button5; //physical
    private Button button6; //chemical
    private Button button7; //biological
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button5 = findViewById(R.id.buttonCharacter1);
        ...
        button6 = findViewById(R.id.buttonCharacter2);
        ...
        button7 = findViewById(R.id.buttonCharacter3);
    ...
    public void openCharacter1(){
        Intent intent = new Intent(this, character1.class);
        startActivity(intent);
    }

    public void openCharacter2(){
        Intent intent = new Intent(this, character2.class);
        startActivity(intent);
    }

    public void openCharacter3(){
        Intent intent = new Intent(this, character3.class);
        startActivity(intent);
    }
